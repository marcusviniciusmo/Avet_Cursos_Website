...
export const AvetAboutText2 = `O projeto Avet nasceu há cinco anos, quando a
  Dra. Maria Arianna começou a lecionar em cursos de Auxiliar Veterinário e
  sentiu a necessidade de ensinar, orientar e ajudar pessoas que amam animais a
  cuidar deles. Ao fazer a formação em Auxiliar Veterinário, o profissional sai
  para o mercado com um bom conhecimento de campo, com amplo conhecimento teórico
